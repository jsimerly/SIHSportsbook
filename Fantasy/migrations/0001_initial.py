# Generated by Django 4.0 on 2022-06-04 14:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Account', '0003_user_account_balance'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playoff_oize', models.IntegerField(choices=[(0, 0), (2, 2), (4, 4), (6, 6), (8, 8), (10, 10), (12, 12), (14, 14), (16, 16), (18, 18), (20, 20)], default=6)),
                ...
                ('league', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='settings', to='Fantasy.fantasyleague')),
            ],
        ),
        migrations.CreateModel(
            name='NflState',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pos', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, choices=[('QB', 'Quarterback'), ('RB', 'Runningback'), ('WR', 'Wide Reciever'), ('TE', 'Tight End'), ('K', 'Kicker'), ('DEF', 'Defense and Special Teams')], max_length=20), blank=True, default=list, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('league_settings', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scoring', to='Fantasy.leaguesettings')),
            ],
        ),
        migrations.CreateModel(
