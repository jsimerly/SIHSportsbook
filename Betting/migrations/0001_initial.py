# Generated by Django 4.0 on 2022-06-27 21:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fantasy_matchup', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='betting_matchups', to='Fantasy.matchup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseplacedbet_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='Betting.baseplacedbet')),
