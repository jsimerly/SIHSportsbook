# Generated by Django 4.0 on 2022-04-25 20:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(null=b'I00\n', on_delete=django.db.models.deletion.PROTECT, related_name='owner', to='auth.user')),
            ],
        ),
        migrations.CreateModel(
            name='FantasyTeam',
            fields=[
                ...
                ('userAccount', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='auth.user')),
            ],
        ),
    ]
